...
<div class="prepend-2 span-20 append-2 line last">
    ...
    <div class="span-5 last">        
        <?php echo Form::input("proveedor", $sla->servicioproveedor->nombre, array('id' => 'proveedor', 'class' => 'span-5')); ?>
        <?php echo Form::hidden("proveedorh", $sla->ServicioProveedor_idServicioProveedor, array('id' => 'proveedorh', 'class' => 'span-5')); ?>
    </div>    	
</div>
