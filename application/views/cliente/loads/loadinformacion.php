    ...
    <div id="rowinformacion_<?php echo $cont; ?>" class="span-19 last line" >
        ...
        <div class="span-6  line"> <?php echo Form::label('tipo_'.$cont,'Tipo:',array('class'=>'span-4')); echo  Form::select('tipo_'.$cont,$tipo,null,array('id'=>'tipo_'.$cont,'class'=>'span-5'));  ?></div>
