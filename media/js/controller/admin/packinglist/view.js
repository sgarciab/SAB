$(document).ready(function() {
    ...
    $('#btn_invoice_detail').bind('click', function() {
        ...
        $('#invoice_print_container').load(document_root + "admin/packinglist/print",
                {
                    packinglist_id: $('#hdn_number').val()
                },
        function() {
            $("#dialog_print_bill").dialog({
                ...
                buttons: {
                    'Imprimir': function() {
                        ...
                        ventimp.print();
                        ventimp.close();
                        window.top.location.href = document_root + 'admin/report/reportpackinglist';
                    },
                    'Cancelar': function() {
