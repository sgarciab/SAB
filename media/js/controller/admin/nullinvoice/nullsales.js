...
//            return false;
   $("#dialog_wrong_date").dialog({
    ...
    function do_search()
    {
        $('#container_null_sales').html('');
        
        $('#container_null_sales').load(document_root + 'admin/rpc/loadnullsalelist',{
            from: $("#since_date").val(),
            to: $("#to_date").val()
        },function() {
                ...
                $('#table-null-invoices').dataTable( {
                    ...
                    "oTableTools": {
                        ...
                        "aButtons": [
                        {
                            "sExtends": "pdf",
                            "mColumns": [ 0, 1, 2, 3],
                            "sFileName":"HistorialVentasAnuladas.pdf",
                            "sPdfOrientation": "landscape",
                            "sPdfSize": "letter",
                            "sPdfMessage": "Historial de Ventas Anuladas"
                        }
                        ]
                    },
                    "bPaginate": true,
